...
class ExtendedProfile(models.Model):
    ...
    zodiac_moon = models.CharField(max_length=80, blank=True)
    hogwarts_house = models.CharField(max_length=80, blank=True)
    scent_family = models.CharField(max_length=120, blank=True)
    favourite_designer = models.CharField(max_length=150, blank=True)
    shoe_brand = models.CharField(max_length=150, blank=True)
    shoe_type = models.CharField(max_length=150, blank=True)
    dream_destination = models.CharField(max_length=150, blank=True)
    biggest_fear = models.CharField(max_length=150, blank=True)
    love_language_to_other = models.CharField(max_length=150, blank=True)
    love_language_for_you = models.CharField(max_length=150, blank=True)
    first_impression_of_me = models.TextField(blank=True)
    comfort_food = models.CharField(max_length=150, blank=True)
    favourite_barbie_film = models.CharField(max_length=150, blank=True)
    favourite_disney_film = models.CharField(max_length=150, blank=True)
